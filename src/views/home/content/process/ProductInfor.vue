...
export default {
  ...
  methods: {
    ...
    showListView: function () {
      ...
      var self = this
      this.$axios.get('process/productInfor/?ordering=' + self.selectItem.ordering).then(function (response) {
  ...
  watch: {
    'type': function (newval, oldval) {
      ...
      this.$axios.get(`process/productType/` + newval.id).then(function (response) {
