  ...
  <div class="materialInfor">
    ...
    <div  class="detail"  v-show="showViewid==='detail'">
      ...
      <div class="content">
          ...
          <div >
            <span class="name">供应商1名称:</span>
            <span class="code">{{vendor1.name}}</span>
          </div>
          <div >
            <span class="name">供应商1编码:</span>
            <span class="code">{{vendor1.code}}</span>
          </div>
          <div >
            <span class="name">供应商2名称:</span>
            <span class="code">{{vendor2.name}}</span>
          </div>
          <div >
            <span class="name">供应商2编码:</span>
            <span class="code">{{vendor2.code}}</span>
          </div>
          <div >
            <span class="name">供应商3名称:</span>
            <span class="code">{{vendor3.name}}</span>
          </div>
          <div >
            <span class="name">供应商3编码:</span>
            <span class="code">{{vendor3.code}}</span>
          </div>
          <div >
            <span class="name">质地:</span>
            <span class="code">{{detail.character}}</span>
          </div>
...
export default {
  ...
  methods: {
    ...
    showListView: function () {
      ...
      var self = this
      this.$axios.get('process/materialInfor/?ordering=' + self.selectItem.ordering).then(function (response) {
  ...
  watch: {
    ...
    'type': function (newval, oldval) {
      ...
      this.$axios.get(`process/materialType/` + newval.id).then(function (response) {
