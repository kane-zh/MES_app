<template>
  <div class="productDailyReport">
      ...
      <div class="content">
        ...
        <dl class="childItem">
          <li v-for="item in detail.child" :key="item.id">
            <span class="productType_name">产品类型:{{"【"+item.productType_name+"】"}}</span>
            <span class="productType_code">{{item.productType_code}}</span>
            <span class="product_name">产品:{{"【"+item.product_name+"】"}}</span>
            <span class="product_code">{{item.product_code}}</span>
    ...
    <div  class="create"  v-show="showViewid==='create'">
      ...
      <form   ref="createForm" >
        <div>产品生产日报名称:
          <input v-model="formItem.name"  placeholder="请输入产品生产日报名称:...">
        </div>
        <div>产品生产日报编码:
          <input v-model="formItem.code"  placeholder="请输入产品生产日报编码:...">
        </div>
        <div>班组:
...
export default {
  ...
  methods: {
    ...
    showListView: function () {
      ...
      var self = this
      this.$axios.get('production/productDailyReport/?ordering=' + self.selectItem.ordering).then(function (response) {
