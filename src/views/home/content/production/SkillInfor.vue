...
export default {
  ...
  methods: {
    ...
    showListView: function () {
      ...
      var self = this
      this.$axios.get('production/skillInfor/?ordering=' + self.selectItem.ordering).then(function (response) {
  ...
  watch: {
    'type': function (newval, oldval) {
      ...
      this.$axios.get(`production/skillType/` + newval.id).then(function (response) {
