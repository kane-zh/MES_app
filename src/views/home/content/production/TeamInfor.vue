  ...
  <div class="teamInfor">
        ...
        <ul>
          <li v-for="item in list" :key="item.id" @click="showDetailView(item.id)">
            ...
            <div class="content">
              ...
              <span class="principal">责任人{{item.principal}}</span>
              <span class="duties">职责{{item.duties}}</span>
    ...
    <div  class="detail"  v-show="showViewid==='detail'">
      ...
      <div class="content">
          ...
          <div >
            <span class="name">车间名称:</span>
            <span class="code">{{type.name}}</span>
          </div>
          <div >
            <span class="name">车间编码:</span>
            <span class="code">{type.code}}</span>
          </div>
          <div >
            <span class="name">车间信息状态:</span>
            <span class="code">{{type.state}}</span>
          </div>
          <div >
          ...
          <div >
            <span class="name">职责:</span>
            <span class="code">{{detail.duties}}</span>
          </div>
...
export default {
  ...
  methods: {
    ...
    showListView: function () {
      ...
      var self = this
      this.$axios.get('production/teamInfor/?ordering=' + self.selectItem.ordering).then(function (response) {
  ...
  watch: {
    'type': function (newval, oldval) {
      ...
      this.$axios.get(`production/workshopInfor/` + newval.id).then(function (response) {
