  ...
  <div class="partsInfor">
    ...
    <div  class="detail"  v-show="showViewid==='detail'">
      ...
      <div class="content">
          ...
          <div >
            <span class="name">供应商编码:</span>
            <span class="code">{{vendor.code}}</span>
          </div>
          <div >
            <span class="name">供应商信息状态:</span>
...
export default {
  ...
  methods: {
    ...
    showListView: function () {
      ...
      var self = this
      this.$axios.get('equipment/partsInfor/?ordering=' + self.selectItem.ordering).then(function (response) {
  ...
  watch: {
    'type': function (newval, oldval) {
      ...
      this.$axios.get(`equipment/partsType/` + newval.id).then(function (response) {
