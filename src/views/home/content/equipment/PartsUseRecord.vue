  ...
  <div class="partsUseRecord">
        ...
        <ul>
          <li v-for="item in list" :key="item.id" @click="showDetailView(item.id)">
            ...
            <div class="content">
              ...
              <span class="sum">数量:{{item.result}}</span>
    ...
    <div  class="detail"  v-show="showViewid==='detail'">
      ...
      <div class="content">
          ...
          <div >
            ...
            <span class="code">{{parts.name}}</span>
          </div>
          <div >
          ...
          <div >
            <span class="name">备品信息状态:</span>
            <span class="code">{{parts.state}}</span>
          </div>
          <div >
    ...
    <div  class="create"  v-show="showViewid==='create'">
      ...
      <form   ref="createForm" >
        ...
        <div>使用数量:
          <input v-model="formItem.sun" type="number" >
        </div>
        <div>审核账号:
...
export default {
  ...
  methods: {
    ...
    showListView: function () {
      ...
      var self = this
      this.$axios.get('equipment/partsUseRecord/?ordering=' + self.selectItem.ordering).then(function (response) {
