  ...
  <div class="equipmentInfor">
    ...
    <div  class="detail"  v-show="showViewid==='detail'">
      ...
      <div class="content">
          ...
          <div v-show="vendor!==null">
            <span class="name">厂商名称:</span>
            <span class="code">{{vendor.name}}</span>
          </div>
          <div v-show="vendor!==null">
            <span class="name">厂商编码:</span>
            <span class="code">{{vendor.code}}</span>
          </div>
          <div  v-show="vendor!==null">
            <span class="name">厂商状态:</span>
            <span class="code">{{vendor.state}}</span>
          </div>
          <div >
            <span class="name">归属单位:</span>
            <span class="code">{{detail.affiliation}}</span>
          </div>
          <div >
            <span class="name">所在位置:</span>
            <span class="code">{{detail.location}}</span>
          </div>
          <div >
            <span class="name">负责人:</span>
            <span class="code">{{detail.principal}}</span>
          </div>
          <div >
            <span class="name">折旧率:</span>
            <span class="code">{{detail.depreciationRate}}</span>
          </div>
          <div >
            <span class="name">启用日期:</span>
            <span class="code">{{+detail.dataOfActivation}}</span>
          </div>
          <div >
            <span class="name">购买日期:</span>
            <span class="code">{{detail.dataOfPurchase}}</span>
          </div>
        ...
        <div >
          <span class="name">备品信息:</span>
        </div>
        <dl class="childItem">
          <li v-for="item in detail.parts" :key="item.id">
...
export default {
  ...
  methods: {
    ...
    showListView: function () {
      ...
      var self = this
      this.$axios.get('equipment/equipmentAccount/?ordering=' + self.selectItem.ordering).then(function (response) {
  ...
  watch: {
    ...
    'type': function (newval, oldval) {
      ...
      this.$axios.get(`equipment/equipmentType/` + newval.id).then(function (response) {
