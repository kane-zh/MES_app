    ...
    <div  class="detail"  v-show="showViewid==='detail'">
      ...
      <div class="content">
          ...
          <div >
            ...
            <span class="code">{{defectGrade.name}}</span>
          </div>
          <div >
            <span class="name">等级编码:</span>
            <span class="code">{{defectGrade.code}}</span>
          </div>
          ...
          <div >
            ...
            <span class="code">{{detail.rule}}</span>
          </div>
          <div >
...
export default {
  ...
  methods: {
    ...
    showListView: function () {
      ...
      var self = this
      this.$axios.get('quality/defectInfor/?ordering=' + self.selectItem.ordering).then(function (response) {
  ...
  watch: {
    'type': function (newval, oldval) {
      ...
      this.$axios.get(`quality/defectType/` + newval.id).then(function (response) {
