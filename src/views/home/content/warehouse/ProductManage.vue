  ...
  <div class="productManage">
        ...
        <ul>
          <li v-for="item in list" :key="item.id" @click="showDetailView(item.id)">
            ...
            <div class="content">
              ...
              <span class="goodsname">产品{{"【"+item.product_name+"】"}}</span>
              <span class="goodscode">{{item.product_code}}</span>
    ...
    <div  class="detail"  v-show="showViewid==='detail'">
      ...
      <div class="content">
          ...
          <div >
            <span class="name">产品类型名称:</span>
            <span class="code">{{detail.productType_name}}</span>
          </div>
          <div >
            <span class="name">产品类型编码:</span>
            <span class="code">{{detail.productType_code}}</span>
          </div>
          <div >
            <span class="name">产品名称:</span>
            <span class="code">{{detail.product_name}}</span>
          </div>
          <div >
            <span class="name">产品编码:</span>
            <span class="code">{{detail.product_code}}</span>
          </div>
          <div >
...
export default {
  ...
  methods: {
    ...
    showListView: function () {
      ...
      var self = this
      this.$axios.get('warehouse/productManage/?ordering=' + self.selectItem.ordering).then(function (response) {
