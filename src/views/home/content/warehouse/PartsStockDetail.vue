  ...
  <div class="partsStock">
    ...
    <div  class="list">
      ...
      <div class="search" v-show="showSearchView===true">
        ...
        <div>备品类型：
          <select v-model="selectItem.partsType" >
            <option selected hidden disabled value="">请选择备品类型</option>
            <option v-for="item in partsType" :value="item.code" :key="item.code">{{item.name}}</option>
          </select>
        </div>
        <div>状态:
        ...
        <ul>
          <li v-for="item in list" :key="item.id" @click="showDetailView(item.id)">
            ...
            <div class="content">
              ...
              <span class="goodsType_name">备品类型：{{"【"+item.partsType_name+"】"}}</span>
              <span class="goodsType_code">{{item.partsType_code}}</span>
              <span class="goods_name">备品{{"【"+item.parts_name+"】"}}</span>
              <span class="goods_code">{{item.parts_code}}</span>
...
export default {
  ...
  methods: {
    ...
    select () {
      ...
      this.showSearchView = false
      var self = this
      this.$axios.get('warehouse/partsStockDetail/?state=' + self.selectItem.state +
