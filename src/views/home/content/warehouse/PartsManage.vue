  ...
  <div class="partsManage">
        ...
        <ul>
          <li v-for="item in list" :key="item.id" @click="showDetailView(item.id)">
            ...
            <div class="content">
              ...
              <span class="goodsname">备品{{"【"+item.parts_name+"】"}}</span>
              <span class="goodscode">{{item.parts_code}}</span>
    ...
    <div  class="detail"  v-show="showViewid==='detail'">
      ...
      <div class="content">
          ...
          <div >
            <span class="name">备品类型名称:</span>
            <span class="code">{{detail.partsType_name}}</span>
          </div>
          <div >
            <span class="name">备品类型编码:</span>
            <span class="code">{{detail.partsType_code}}</span>
          </div>
          <div >
            <span class="name">备品名称:</span>
            <span class="code">{{detail.parts_name}}</span>
          </div>
          <div >
            <span class="name">备品编码:</span>
            <span class="code">{{detail.parts_code}}</span>
          </div>
          <div >
...
export default {
  ...
  methods: {
    ...
    showListView: function () {
      ...
      var self = this
      this.$axios.get('warehouse/partsManage/?ordering=' + self.selectItem.ordering).then(function (response) {
