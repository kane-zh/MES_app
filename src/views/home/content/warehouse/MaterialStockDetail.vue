  ...
  <div class="materialStock">
    ...
    <div  class="list">
      ...
      <div class="search" v-show="showSearchView===true">
        ...
        <div>物料类型：
          <select v-model="selectItem.materialType">
            <option selected hidden disabled value="">请选择物料类型</option>
            <option v-for="item in materialType" :value="item.code" :key="item.code">{{item.name}}</option>
          </select>
        </div>
        <div>状态:
        ...
        <ul>
          <li v-for="item in list" :key="item.id" @click="showDetailView(item.id)">
            ...
            <div class="content">
              ...
              <span class="goodsType_name">物料类型：{{"【"+item.materialType_name+"】"}}</span>
              <span class="goodsType_code">{{item.materialType_code}}</span>
              <span class="goods_name">物料:{{"【"+item.material_name+"】"}}</span>
              <span class="goods_code">{{item.material_code}}</span>
...
export default {
  ...
  methods: {
    ...
    select () {
      ...
      var self = this
      this.$axios.get('warehouse/materialStockDetail/?state=' + self.selectItem.state +
