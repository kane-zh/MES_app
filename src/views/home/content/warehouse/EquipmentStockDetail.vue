  ...
  <div class="equipmentStock">
    ...
    <div  class="list">
      ...
      <div class="search" v-show="showSearchView===true">
        ...
        <div>设备类型：
          <select v-model="selectItem.equipmentType">
            <option selected hidden disabled value="">请选择设备类型</option>
            <option v-for="item in equipmentType" :value="item.code" :key="item.code">{{item.name}}</option>
          </select>
        </div>
        <div>状态:
        ...
        <ul>
          <li v-for="item in list" :key="item.id" @click="showDetailView(item.id)">
            ...
            <div class="content">
              ...
              <span class="goodsType_name">设备类型：{{"【"+item.equipmentType_name+"】"}}</span>
              <span class="goodsType_code">{{item.equipmentType_code}}</span>
              <span class="goods_name">设备{{"【"+item.equipment_name+"】"}}</span>
              <span class="goods_code">{{item.equipment_code}}</span>
...
export default {
  ...
  methods: {
    ...
    select () {
      ...
      var self = this
      this.$axios.get('warehouse/equipmentStockDetail/?state=' + self.selectItem.state +
    ...
    clear () {
      ...
      this.searchItem.equipmentTypee = ''
