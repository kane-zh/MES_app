        ...
        <ul>
          <li v-for="item in list" :key="item.id" @click="showDetailView(item.id)">
            ...
            <div class="content">
              ...
              <span class="goodsname">物料:{{"【"+item.material_name+"】"}}</span>
              <span class="goodscode">{{item.material_code}}</span>
    ...
    <div  class="detail"  v-show="showViewid==='detail'">
      ...
      <div class="content">
          ...
          <div >
            ...
            <span class="code">{{detail.materialType_name}}</span>
          </div>
          <div >
            <span class="name">物料类型编码:</span>
            <span class="code">{{detail.materialType_code}}</span>
          </div>
          <div >
            <span class="name">物料名称:</span>
            <span class="code">{{detail.material_name}}</span>
          </div>
          <div >
            <span class="name">物料编码:</span>
            <span class="code">{{detail.material_code}}</span>
          </div>
          <div >
...
export default {
  ...
  methods: {
    ...
    showListView: function () {
      ...
      var self = this
      this.$axios.get('warehouse/materialManage/?ordering=' + self.selectItem.ordering).then(function (response) {
