  ...
  <div class="semifinishedManage">
        ...
        <ul>
          <li v-for="item in list" :key="item.id" @click="showDetailView(item.id)">
            ...
            <div class="content">
              ...
              <span class="goodsname">半成品{{"【"+item.semifinished_name+"】"}}</span>
              <span class="goodscode">{{item.semifinished_code}}</span>
    ...
    <div  class="detail"  v-show="showViewid==='detail'">
      ...
      <div class="content">
          ...
          <div >
            <span class="name">物料类型名称:</span>
            <span class="code">{{detail.semifinishedType_name}}</span>
          </div>
          <div >
            <span class="name">物料类型编码:</span>
            <span class="code">{{detail.semifinishedType_code}}</span>
          </div>
          <div >
            <span class="name">物料名称:</span>
            <span class="code">{{detail.semifinished_name}}</span>
          </div>
          <div >
            <span class="name">物料编码:</span>
            <span class="code">{{detail.semifinished_code}}</span>
          </div>
          <div >
            <span class="name">批次:</span>
            <span class="code">{{detail.batch}}</span>
          </div>
          <div >
...
export default {
  ...
  methods: {
    ...
    showListView: function () {
      ...
      var self = this
      this.$axios.get('warehouse/semifinishedManage/?ordering=' + self.selectItem.ordering).then(function (response) {
