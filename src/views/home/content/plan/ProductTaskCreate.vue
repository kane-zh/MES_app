...
<!--            <span class="salesOrder_code">{{item.salesOrderItem_parent.salesOrder_code}}</span>-->
            <span class="productType_name">产品类型:{{"【"+item.salesOrderItem.productType_name+"】"}}</span>
            <span class="productType_code">{{item.salesOrderItem.productType_code}}</span>
            <span class="product_name">产品:{{"【"+item.salesOrderItem.product_name+"】"}}</span>
            <span class="product_code">{{item.salesOrderItem.product_code}}</span>
...
export default {
  ...
  methods: {
    ...
    showListView: function () {
      ...
      var self = this
      this.$axios.get('plan/productTaskCreate/?ordering=' + self.selectItem.ordering).then(function (response) {
...
<style scoped lang="scss" >
  ...
  .detail .content .childItem  li .salesOrder_name{
    position: absolute;
    top:0;
    left: 0;
    width: 60%;
  ...
  .detail .content .childItem  li .salesOrder_code{
    position: absolute;
    top:0;
    left: 60%;
    width: 40%;
